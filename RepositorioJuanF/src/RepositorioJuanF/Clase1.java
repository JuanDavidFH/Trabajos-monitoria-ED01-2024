...
public class Clase1 {
    public static void main(String[] args) {
        ...
        TareasPorHacer.add("Tender la cama");
        TareasPorHacer.add("Hacer el desayuno");
        TareasPorHacer.add("Realizar los trabajos");
        TareasPorHacer.add("Pasear el perro");
        TareasPorHacer.add("Sacar la basura");
